        ...
        <Container size="sm">
          ...
          >
            ...
            <div className="text-center mb-8">
              ...
              <h1 className="font-display text-3xl font-bold mb-2">Join EmotionCreator</h1>
              <p className="text-text-secondary">Create an account to save your pages</p>
            </div>
            ...
            >
              <div className="flex items-start gap-3">
                ...
                <p className="text-sm text-yellow-200">
                  <strong>Without an account</strong>, your created pages will be lost when you close the browser. Sign up to keep them forever!
                </p>
              </div>
            </motion.div>
